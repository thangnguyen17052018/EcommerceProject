...
public class ShoppingCartRestController {
	...
	@Autowired private ShoppingCartService shopingCartService;
	...
	public String addProductToCart(@PathVariable("productId") Integer productId,
		...
		try {			
			...
			Integer updatedQuantity = shopingCartService.addProduct(productId, quantity, customer);
		...
		catch(ShoppinngCartException ex) {
	...
	public String removeProduct(@PathVariable("productId") Integer productId, HttpServletRequest request) {
		...
		try {
			Customer customer  = getAuthenticatedCustomer(request);
			shopingCartService.removeProduct(productId, customer);
